...
Rails.application.configure do
  ...
  # Action Cable allows any origin in development. In production it must be configured.
  config.action_cable.allowed_request_origins = [ /https:\/\/.*\.herokuapp\.com/, /http:\/\/.*\.herokuapp\.com/, "http://localhost:3000" ]
